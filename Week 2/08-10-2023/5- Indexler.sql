...
Create Table orders as Select * From Sales_Orders;

Select * From ORDERS;

Set autotrace ON;
Select ORDERID From Sales_Orders Where ORDERID = 10312;

Create Index inx_orders_orderid1 on Sales_Orders(ORDERID);

/

-- DEPARTMENTS TABLOSU DENEMESI
Create Index inx_departments_depid on Departments(department_id);
/
Select * from departments;
/
Set autotrace ON;
Select department_id From departments Where department_id = 150;
/


Set autotrace ON;
Select * From Sales_Orders Where ORDERID = 10312;
